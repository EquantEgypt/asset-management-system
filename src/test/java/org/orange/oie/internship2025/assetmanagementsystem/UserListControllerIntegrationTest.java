 ...
 class UserListControllerIntegrationTest {
     ...
     void setUp() {
         ...
         String adminCredentials = "admin@orange.com:admin123";
         adminAuthHeader = "Basic " + Base64.getEncoder().encodeToString(adminCredentials.getBytes());
         String managerCredentials = "manager1@orange.com:admin123";
     ...
     void getAllUsersForRoleAdmin() throws Exception {
         ...
         mockMvc.perform(get("/api/users")
                 ...
                 .andExpect(jsonPath("$.content[1].email").value("manager1@orange.com"));
     }
