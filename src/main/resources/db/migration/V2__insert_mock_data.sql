...
-- Asset Assignments
-- ========================
INSERT INTO asset_assignment (id, asset_id, assigned_to_user_id, assignment_date, status, return_date, note) VALUES
 (1, 2, 2, '2024-06-01', 'ACTIVE', NULL, 'HP ProBook assigned to Maryiam'),
 (2, 4, 7, '2024-06-15', 'ACTIVE', NULL, 'HP OfficeJet printer assigned to Zeyad'),
 (3, 6, 11, '2024-07-01', 'ACTIVE', NULL, 'Samsung Monitor assigned to Seifalla'),
 (4, 9, 14, '2024-07-20', 'ACTIVE', NULL, 'Standing desk assigned to Malak'),
 (5, 11, 13, '2024-08-01', 'ACTIVE', NULL, 'Office chair assigned to Marim'),
 (6, 13, 9, '2024-08-15', 'ACTIVE', NULL, 'Camera assigned to Mohamed Magdy'),
 (7, 15, 6, '2024-09-01', 'ACTIVE', NULL, 'Server assigned to Wafaa IT staff');
